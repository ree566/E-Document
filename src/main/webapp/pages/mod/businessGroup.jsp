...
<script>
    $(function () {
        var grid = $("#list");
        var tableName = "BusinessGroup";

        grid.jqGrid({
            url: '<c:url value="/BusinessGroup/read" />',
            datatype: 'json',
            mtype: 'GET',
            autoencode: true,
            colModel: [
        ...
        grid.jqGrid('navGrid', '#pager',
                ...
                {
                    url: '<c:url value="/BusinessGroup/update" />',
                    dataheight: 350,
                    width: 450,
                ...
                {
                    url: '<c:url value="/BusinessGroup/create" />',
                    dataheight: 350,
                    width: 450,
                ...
                {
                    url: '<c:url value="/BusinessGroup/delete" />',
                    zIndex: 9999,
                    reloadAfterSubmit: true
                },
                {
