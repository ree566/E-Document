...
//            guiStyle: "bootstrap",
            ...
            colModel: [
                ...
                {label: 'Test Profile', name: "testProfile", width: 100, search: true, searchrules: {required: true}, searchoptions: search_string_options, edittype: "select", editoptions: {value: "0:0;M5:M5;601:601;B-B:B-B;EKI9528:EKI9528", defaultValue: "0", dataEvents: testProfile_select_event}},
