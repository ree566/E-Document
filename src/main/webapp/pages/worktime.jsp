...
//            guiStyle: "bootstrap",
            ...
            colModel: [
                ...
                {label: '工單產品別', name: "poCategory", edittype: "select", editoptions: {value: "M/B:M/B; :empty", defaultValue: 'M/B'}, width: 120, searchrules: {required: true}, searchoptions: search_string_options},
                ...
                {label: 'SN是否等於SSN', name: "partNoAttributeMaintain", edittype: "select", editoptions: {value: "Y:Y;N:N", defaultValue: ' '}, width: 120, searchrules: {required: true}, searchoptions: search_string_options},
                ...
                {label: '禮盒總重量(附加屬性質)(kg)', name: "weightAff", width: 100, searchrules: number_search_rule, searchoptions: search_decimal_options, editrules: {number: true, required: true}, editoptions: {defaultValue: '0'}},
