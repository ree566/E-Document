...
//            guiStyle: "bootstrap",
            ...
            colModel: [
                ...
                {label: 'SN是否等於SSN', name: "partNoAttributeMaintain", edittype: "select", editoptions: {value: "Y:Y;N:N", defaultValue: 'N'}, width: 120, searchrules: {required: true}, searchoptions: search_string_options},
