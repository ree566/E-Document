...
//            guiStyle: "bootstrap",
            ...
            colModel: [
                ...
                {label: '啟用料號屬性', name: "labelInformation", edittype: "select", editoptions: {value: "N:N; :empty", defaultValue: ' '}, width: 120, searchrules: {required: true}, searchoptions: search_string_options},
