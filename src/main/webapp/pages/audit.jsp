        ...
        function getEditRecord(id, modelName, version, startDate, endDate) {
            grid.jqGrid({
                ...
                colModel: [
                    ...
                    {label: 'Hi-Pot', name: "hiPotLeakage", jsonmap: "0.hiPotLeakage", width: 100, searchrules: number_search_rule, searchoptions: search_decimal_options},
                    ...
                    {label: '工單產品別', name: "poCategory", jsonmap: "0.poCategory", width: 100, searchrules: {required: true}, searchoptions: search_string_options},
                    ...
                    {label: 'GND Value', name: "gndValue", jsonmap: "0.gndValue", width: 120, searchrules: {required: true}, searchoptions: search_string_options},
