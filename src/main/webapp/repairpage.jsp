...
//                    $("#startSchedArea").block({message: "請先登入線別。", css: {cursor: 'default'}, overlayCSS: {cursor: 'default'}});
                ...
                $(".start-timer-btn").on("click", function (e) {
                    ...
                    var barcodeValue = container.find(".barcode").val();
                    if (barcodeValue == null || barcodeValue == "") {
                        alert("Please insert barcode first");
                        e.stopImmediatePropagation();
                        return false;
                    }
                    container.find(".barcode, .timer-destroy").prop("disabled", true);
                });

                $(".remove-timer-btn").on("click", function () {
                    $(this).parents(".timer-container").find(".barcode, .timer-destroy").prop("disabled", false);
                });
                ...
                <div>
                    ...
                    <div id="timer-area">
                        <div class="row timer-container">
                            <div class="col-md-3">
                                <input name="barcode" class="form-control barcode" placeholder="Please insert your barcode" type="text">
                            </div>
                            <div class="col-md-3">
