 ...
 * @author Wei.Cheng
 */
public class SheetSPEDAO extends BasicDAO{
    ...
    public List<Map> getAll(){
        return queryForMapList(getConn(), "SELECT * FROM Sheet_SPE");
    }
    
    public List<Map> getColumn(){
        return queryForMapList(getConn(), "SELECT top 1 * FROM Sheet_SPE");
    }
}
