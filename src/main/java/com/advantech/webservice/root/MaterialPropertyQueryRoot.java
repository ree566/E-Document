...
public class MaterialPropertyQueryRoot {
    ...
    protected MaterialPropertyQueryRoot.MATPROPERTYVALUE matpropertyvalue;

    public MaterialPropertyQueryRoot() {
        this.method = new MaterialPropertyQueryRoot.METHOD();
        this.matpropertyvalue = new MaterialPropertyQueryRoot.MATPROPERTYVALUE();
    }
     ...
     *
     */
    public MaterialPropertyQueryRoot.MATPROPERTYVALUE getMATPROPERTYVALUE() {
     ...
     *
     */
    public void setMATPROPERTYVALUE(MaterialPropertyQueryRoot.MATPROPERTYVALUE value) {
