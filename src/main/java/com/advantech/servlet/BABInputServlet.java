 ...
 * @author Wei.Cheng
 */
@WebServlet(name = "BABInputServlet", urlPatterns = {"/BABInputServlet"})
public class BABInputServlet extends HttpServlet {
    
    private static final Logger log = LoggerFactory.getLogger(BABInputServlet.class);
